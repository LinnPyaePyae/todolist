...
const arrmap = products.map((product) => {
    product.price += 100;
    product.title = 'MMS ' + product.title;
    // return product;

    //လိုချင်တဲ့ဟာလေးပဲ object နဲ့ပြတာ
    // return {
    //     title: product.title,
    //     price: product.price,
...
//filter
// const arrfilter = products.filter((product) => [1, 7, 5, 9].includes(product.id)
//     // return product.price < 50;
// );
// console.log(arrfilter);

const arrfil = products.filter((product) => {
    // return product.id === 5 || product.id === 3 || product.id == 1;
    return [1, 7, 5].includes(product.id);
});
// console.log(arrfil);
...
//find()
const objfind = products.find((product) => {
    // console.log(product.id);
    // return product.id === 5;
});
// console.log(objfind);
...
// fruits.forEach((fruit, index, arr) => console.log(fruit, index));

// let newFruitArray = fruits.forEach((fruit) => {
//     return fruit;
// });
...
//map
// const mapfruit = fruits.map((fruit) => console.log(fruit));
...
// console.log(fruits.indexOf('juice'));
...
// console.log(fruits.splice(0, 4, 'aa', 'bb', 'cc', 'dd'));
// console.log(fruits);
...
// console.log(['lpp', ...fruits, ...arr, 'arr', ...nums]);
// console.log(...fruits);
